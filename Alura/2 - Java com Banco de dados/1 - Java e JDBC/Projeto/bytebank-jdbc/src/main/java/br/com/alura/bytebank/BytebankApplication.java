...
public class BytebankApplication {
    ...
    private static int exibirMenu() {
        System.out.println("""
                ...
                7 - Realizar trasnferência em uma conta
                8 - Sair
                """);
    ...
    private static void realizarTrasferencia() {
        ...
        service.realizarTrasferencia(numeroDaContaOrigem, numeroDaContaDestino, valor);

        System.out.println("Trasferência realizado com sucesso!");
        System.out.println("Pressione qualquer tecla e de ENTER para voltar ao menu principal");
        teclado.next();
    }
}
